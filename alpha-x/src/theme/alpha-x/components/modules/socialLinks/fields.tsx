...
export const fields = (
  <ModuleFields>
    <FieldGroup name="social_icon" label="Social Icon">
      <RepeatedFieldGroup
        name="items"
        label="Items"
     ...
     default={[
  {
    ...
    link_field: {
      url: { type: "EXTERNAL", href: "https://facebook.com" },
    },
  },
  {
    icon_choice: "hubspot_icon",
    ...
    link_field: {
      url: { type: "EXTERNAL", href: "https://instagram.com" },
    },
  },
  {
    icon_choice: "hubspot_icon",
    ...
    link_field: {
      url: { type: "EXTERNAL", href: "https://linkedin.com" },
    },
  }
]}
>
        ...
        <IconField
          ...
          visibility={{
            controlling_field: "social_icon.items.icon_choice",
            operator: "EQUAL",
