  ...
  <ModuleFields>
    ...
    <FieldGroup name="add_heading" label="Add Heading">
      <RichTextField
        name="heading"
        label="Heading"
        default="<h2>Frequently Asked Questions</h2> <p>Here are answers to some common questions. If you have more inquiries, feel free to contact us!</p>"
      />
    </FieldGroup>
      ...
      <FieldGroup name="faq_style" label="FAQ Style">
        <FieldGroup name="faq_list_bg" label="Faq List Background Color">
          <ColorField
            ...
            default={{ color: "#faf9fb", opacity: 100 }}
          />
        </FieldGroup>
        ...
        <FieldGroup name="icon_types_style" label="Icon Types & Style">
          ...
          <ColorField
            name="icon_color"
            label="Icon Color"
            default={{ color: "#151367" }}
          />
          <ColorField
            name="icon_color_hover_active"
            label="Icon Color Hover / Active"
            default={{ color: "#ef3b23" }}
          />
          <BooleanField
            name="icon_bg_style_enable"
            label="Icon Background style Show/Hide"
            default={false}
          />
          <FieldGroup
            name="icon_background_style"
            label="Icon background Style"
            visibility={{
              controlling_field_path:
                "style.faq_style.icon_types_style.icon_bg_style_enable",
              operator: "EQUAL",
              controlling_value_regex: "true",
            }}
          >
        ...
        <FieldGroup name="box_shadow_edit" label="Box Shadow Edit">
          <BooleanField
            name="box_shadow_enable"
            label="Box Shadow Show/Hide"
            default={true}
          />
          <FieldGroup
            name="box_shadow"
            ...
            visibility={{
              controlling_field_path:
                "style.faq_style.box_shadow_edit.box_shadow_enable",
              operator: "EQUAL",
              controlling_value_regex: "true",
            }}
          >
            <ChoiceField
              name="shadowType"
              label="Shadow Type (Inset/Outset) Type"
              choices={[
                ["outset", "Outset"],
                ["inset", "Inset"],
              ]}
            ...
            <NumberField
              ...
              label="Horizontal Offset (X Offset)"
              display="slider"
              min={0}
              max={40}
              default={0}
            ...
            <NumberField
              ...
              label="Vertical Offset (Y Offset)"
              display="slider"
              min={0}
              max={40}
              default={2}
        ...
        <BooleanField
          name="two_column_layout_enable"
          label="Two Column Layout Show Hide"
          default={true}
        />
        <FieldGroup
          name="two_column_faq_setting"
          label="Two Colum Faq setting"
          visibility={{
        ...
        >
          <NumberField
            name="faq_item_column_number"
            label="Faq Items Left column Show Number"
            default={3}
          />
          <NumberField
            name="column_center_spacing"
            label="Column Center Spacing"
            display="slider"
            min={0}
            max={100}
            default={30}
