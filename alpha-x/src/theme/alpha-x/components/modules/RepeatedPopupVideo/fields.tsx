...
export const fields = (
  <ModuleFields>
    ...
    <RepeatedFieldGroup
      name="heading_video"
      label="Video Repeater"
      occurrence={{ min: 0, max: 20, default: 3 }}
      default={[
        {
          main_heading: {
            heading:
              "<h2>Engaging Video Experience with Modern Overlay Design</h2><p>Capture attention instantly with a sleek video popup featuring a smooth overlay and dynamic play button. Perfect for showcasing product demos, customer stories, or brand videos in a clean, stylish format.</p>",
          },
          popup_enable: {
            enable: true,
          },
          video_image: {
            video_choice: "embed_code",
           video_thumnail: {
        image: {
          size_type: "auto",
          src: simpleImage,
      ...
      <FieldGroup name="video_image" label="Video / Image">
        ...
        <FieldGroup name="video_thumnail" label="Thumnail Image">
          <ImageField
            ...
            visibility={{
              controlling_field: "heading_video.video_image.video_choice",
              operator: "EQUAL",
